...
.. mermaid::
   ...
   flowchart LR
       ...
       B --> C["multi step json with memory output"]
       C --> D["JSON payload and trace"]

Technical Walkthrough
---------------------

1. Configure the runtime surface for `agents` use-cases and run `multi_step_json_with_memory`.
...
Run with `PYTHONPATH=src python3 examples/agents/multi_step_json_with_memory.py`.
