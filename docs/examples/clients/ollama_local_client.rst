...
.. mermaid::
   ...
   flowchart LR
       ...
       B --> C["ollama local client response"]
       C --> D["Describe and trace metadata"]

Technical Walkthrough
---------------------

1. Configure the runtime surface for `clients` use-cases and run `ollama_local_client`.
...
Run with `PYTHONPATH=src python3 examples/clients/ollama_local_client.py`.
