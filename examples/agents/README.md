...
- `workflow_study_delegate.py` shows how packaged-problem study metadata can be turned into a
  prompt-mode workflow execution through `WorkflowStudyDelegate`.
