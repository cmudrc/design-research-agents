...
flowchart LR
    ...
    B --> C["workflow prompt mode final output"]
    C --> D["Trace metadata"]
```

Technical Walkthrough
1. Configure the runtime surface for `workflow` use-cases and run `workflow_prompt_mode`.
...
Discussion
Run with `PYTHONPATH=src python3 examples/workflow/workflow_prompt_mode.py`.
