...
from design_research_agents.contracts import LLMChatParams, LLMClient, LLMMessage, LLMResponse
...
def run_representative_chat(
    *,
    ...
    deterministic_mode = (
        os.environ.get("DRA_EXAMPLE_LLM_MODE", "").strip().lower() == "deterministic"
    )
