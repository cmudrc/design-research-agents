    ...
    def _run_propose_critic(
        ...
        *,
        ...
        def _state_reducer(
            ...
            critique_iterations = _normalize_mapping_records(next_state.get("critique_iterations"))
        ...
        critique_iterations = _normalize_mapping_records(final_state.get("critique_iterations"))
