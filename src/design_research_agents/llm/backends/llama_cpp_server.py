...
class LlamaCppServerBackend:
    ...
    def _resolve_hf_model_name(self) -> None:
        ...
        suffix_matches = [
            ...
            if filename.lower().endswith(requested_model.lower())
        ]
        ...
        quant_matches = [
            filename for filename in gguf_files if filename.lower().endswith(quant_suffix)
        ]
    ...
    def _wait_until_ready(self) -> None:
        ...
        raise RuntimeError(
            "Timed out waiting for llama-cpp server readiness at "
