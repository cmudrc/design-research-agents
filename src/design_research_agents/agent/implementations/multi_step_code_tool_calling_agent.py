...
from design_research_agents.agent.internal.multi_step_code_runtime_helpers import (
...
class MultiStepCodeToolCallingAgent(Agent):
    ...
    def _run_loop_iteration(
        ...
        *,
        ...
        final_output, terminated_reason, should_continue_next, fatal_error, fatal_metadata = (
            _resolve_step_completion(
